...
const lineArray=[line1,line2,line3,line4,line4,line5,line6,line7,line8];
...
const msgtxt1= '<p class="image"><img src = "img/penguins.jpg" width=61px height=61px></p><font color="#CC0000"><p class="text">Penguins Attack!(your turn)</p>';
const msgtxt2= '<p class="image"><img src = "img/whitebear.jpg" width=61px height=61px></p><font color="#0066FF"><p class="text">WhiteBear Attack!(computer turn)</p>';
const msgtxt3= '<p class="image"><img src = "img/penguins.jpg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInRight"><font color="#FFFFFF">Penguins Win!!</p>';
const msgtxt4= '<p class="image"><img src = "img/whitebear.jpg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInLeft"><font color="#FFFFFF">WhiteBear Win!!</p>';
const msgtxt5= '<p class="image"><img src = "img/penguins.jpg" width=61px height=61px><img src = "img/whitebear.jpg" width=61px height=61px></p><p class="text animate__bounceIn"><font color="#FFFFFF">Draw!!</p>';
...
squaresArray.forEach(function(square){
    square.addEventListener('click',()=>{
        if(counter===9){
            const leveBox = document.getElementById("level-Box");
